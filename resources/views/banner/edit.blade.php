        ...
        <div class="page-body">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div>
                            <img src="{{asset('banner/'.$data->image)}}" class="w-25" alt="" id="preview"> <br>
